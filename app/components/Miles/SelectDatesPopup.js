            ...
            <View style={{backgroundColor: 'white', borderRadius: 5}}>
                <View style={{padding: 10, paddingLeft: 20}}>
                    ...
                    <View style={{flexDirection: 'row', marginTop: 10, alignItems: 'center'}}>
                        ...
                        <TouchableOpacity style={{flex: 1, minHeight: 30}} onPress={() => this.showDatePicker(SelectDatesPopup.START_DATE)}>
                            <DateTimePicker
                    ...
                    <View style={{flexDirection: 'row', marginTop: 10, alignItems: 'center'}}>
                        ...
                        <TouchableOpacity style={{flex: 1, minHeight: 30}} onPress={() => this.showDatePicker(SelectDatesPopup.END_DATE)}>
                            <DateTimePicker
